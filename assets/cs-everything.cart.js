...
Shopify.updateCartInfo = function(cart, cart_summary_id, cart_count_id) {
          ...
          if (key === 'items') {
            ...
            if (value.length) {
              ...
              jQuery.each(value, function(i, item) {
                console.log(Shopify.formatMoney(item.price, ""));
  ...
  function updateCartDesc(data){
    ...
    $('.ajax-subtotal').html("<span class='money'>"+Shopify.formatMoney(data.total_price, "")+"</span>");
    
    currenciesCallbackSpecial('.ajax-subtotal span.money, .ajax-cart-subtotal span.money');
